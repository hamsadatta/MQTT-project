...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
			...
			self.lineEdit_motion.setGeometry(QtCore.QRect(80, 140, 90, 20))
			...
			self.lineEdit_smoke.setGeometry(QtCore.QRect(80, 30, 90, 20))
			...
			self.lineEdit_motion_2.setGeometry(QtCore.QRect(80, 80, 90, 20))
			...
			self.label_8.setGeometry(QtCore.QRect(10, 62, 81, 16))
			self.label_8.setObjectName(_fromUtf8("label_8"))
			self.label_9 = QtGui.QLabel(self.groupBox_3)
			self.label_9.setGeometry(QtCore.QRect(10, 92, 81, 16))
			self.label_9.setObjectName(_fromUtf8("label_9"))
			self.label_10 = QtGui.QLabel(self.groupBox_3)
			self.label_10.setGeometry(QtCore.QRect(10, 122, 81, 16))
			self.label_10.setObjectName(_fromUtf8("label_10"))
			self.label_11 = QtGui.QLabel(self.groupBox_3)
			self.label_11.setGeometry(QtCore.QRect(120, 123, 81, 16))
			self.label_11.setObjectName(_fromUtf8("label_11"))
			self.lineEdit_GPSLoc = QtGui.QLineEdit(self.groupBox_3)
			self.lineEdit_GPSLoc.setGeometry(QtCore.QRect(70, 60, 80,20))
			self.lineEdit_GPSLoc.setReadOnly(True)
			self.lineEdit_GPSLoc.setObjectName(_fromUtf8("lineEdit_GPSLoc"))
			self.lineEdit_GPSLon = QtGui.QLineEdit(self.groupBox_3)
			self.lineEdit_GPSLon.setGeometry(QtCore.QRect(70, 90, 80,20))
			self.lineEdit_GPSLon.setReadOnly(True)
			self.lineEdit_GPSLon.setObjectName(_fromUtf8("lineEdit_GPSLon"))
			self.lineEdit_GPSDis = QtGui.QLineEdit(self.groupBox_3)
			self.lineEdit_GPSDis.setGeometry(QtCore.QRect(70, 120, 50,20))
			...
			QtCore.QObject.connect(self.pushButton_ConBrok, QtCore.SIGNAL(_fromUtf8("clicked()")), self.now_this)
			QtCore.QObject.connect(self.pushButton_Loc, QtCore.SIGNAL(_fromUtf8("clicked()")), self.now_loc)
			QtCore.QObject.connect(self.pushButton_FB, QtCore.SIGNAL(_fromUtf8("clicked()")), self.now_fb)
			#QtCore.QObject.connect(self.pushButton_ConBrok, QtCore.SIGNAL(_fromUtf8("clicked()")), self.now_this)
	...
	def now_this(self):
			...
			self.Status.setText(_translate("MainWindow", "connected", None))
	...
	def retranslateUi(self, MainWindow):
			...
			self.label_10.setText(_translate("MainWindow", "Distance:", None))
			self.label_11.setText(_translate("MainWindow", "Kms from Base", None))
			self.lineEdit_GPSLoc.setPlaceholderText(_translate("MainWindow", "Latitude", None))
			self.lineEdit_GPSLon.setPlaceholderText(_translate("MainWindow", "Longitude", None))
			self.lineEdit_GPSDis.setPlaceholderText(_translate("MainWindow", "Dist.", None))
